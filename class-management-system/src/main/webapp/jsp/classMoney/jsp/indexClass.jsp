...
<script type="text/javascript" src="${webPath}jsp/classMoney/js/moneyClass.js?v=2017030902"></script>
...
<!-- 						<input class="form-control input-large" id="searchTxt" param="search.content" placeholder="按班级查询"> -->
<!-- 					</div> -->
