...
<script type="text/javascript" src="${webPath}jsp/StudentScore/js/score.js?v=2017030902"></script>
	    ...
	    <div class="mb10 mt10 searchVo">
				<form class=" form-inline form-inline-sm">
					<c:if test="${user.type != '3' }">
						<a role="button" class="btn btn-primary mr8" href="${webPath}studentScore/toCreateStudentScore.do"  >新建</a>
					...
					<c:if test="${user.type != '3' }">
					<div class="form-group form-group-sm">
		                <label class="control-label sr-only">课程类型:</label>
		                <select class="form-control input-medium" param="search.courseId">
		                    <option value="" selected="selected" style="display: none">请选择课程</option>
			    ...
			    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="mytable caozuo  mb20 table">
					<tr>
							...
							<th class="text-left" width="15%">课程</th>
							<th class="text-left" width="15%">分数</th>
...
/* 		function getById (id){
		...
		function delete_all(type,id){
			...
			var url="${webPath}studentScore/deleteStudentScore.do?keyArr="+ids;
