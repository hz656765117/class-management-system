...
<script type="text/javascript" src="${webPath}jsp/studyMng/classCourse/js/classCourse.js?v=2017030902"></script>
...
<%-- 				<a class="blue f12" style="margin-left:18px;" href="JavaScript:window.open('${webPath}/helps/helps_list_80.html')"><img src="${webPath}images/admin/grayquestion.png" class="ver-3 mr5">使用帮助</a> --%>
	    ...
	    <div class="mb10 mt10 searchVo">
				<form class=" form-inline form-inline-sm">
					<!-- 点击新建的时候是展示另外一个界面 -->
					<a role="button" class="btn btn-primary mr8" href="${webPath}studyMng/classCourse/toCreateClassCourse.do"  >新建</a>
...
<!-- 						<input class="form-control input-large" id="searchTxt" param="search.content" placeholder="按课程名称查询"> -->
<!-- 					</div> -->
<!-- 					<a role="button" class="btn btn-success btn-primary">查询</a> -->
			    ...
			    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="mytable caozuo  mb20 table">
					<tr>
							...
							<th class="text-left" width="45%">课程</th>
...
<!-- 选择判断是否的选择面板 -->
 ...
 <script type="text/javascript">
		...
		function delete_all(type,id){
			...
			//执行删除方法
			var url="${webPath}studyMng/classCourse/deleteclassCourse.do?keyArr="+ids;
		...
		//获取修改面板		
// 		function getById (id){
// 			var url="${webPath}studyMng/course/toUpdateCourse.do?id="+id;
// 			location = url;
// 		}
 </script>