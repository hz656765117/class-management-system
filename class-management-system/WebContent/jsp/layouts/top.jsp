...
<div class="navbar-header clearfix">
    <a href="${webPath}" class="logo">
       <span style="color:red;"> <h1>班级管理系统</h1> </span>
        <%-- <img src="${webPath}images/admin/logo.png"> --%>
        <div style="width:146px; height:30px;">
        <span style="color:white; line-height: 30px; font-size: 18px;">
 			  班级管理系统
   			</span>
   </div>
    </a>
...
<%--         <sec:authorize access="hasRole('ADMIN')">
        ...
        <li><a href="${webPath}login/logOut.do" class="back"><img style="margin-right:10px;vertical-align:-2px;" src="${webPath}images/admin/dzback.png">退出</a></li>
    </ul>
</div>
