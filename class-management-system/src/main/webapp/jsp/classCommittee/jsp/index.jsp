...
<script type="text/javascript" src="${webPath}jsp/classCommittee/js/committee.js?v=2017030902"></script>
	    ...
	    <div class="mb10 mt10 searchVo">
				<form class=" form-inline form-inline-sm">
					<c:if test="${user.type != '3' }">
						<a role="button" class="btn btn-primary mr8" href="${webPath}classCommittee/toCreateClassCommittee.do"  >新建</a>
			    ...
			    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="mytable caozuo  mb20 table">
					<tr>
							...
							<th class="text-left" width="30%">班级</th>
							<th class="text-left" width="15%">班委</th>
...
/* 		function getById (id){
		...
		function delete_all(type,id){
			...
			var url="${webPath}classCommittee/deleteClassCommittee.do?keyArr="+ids;
