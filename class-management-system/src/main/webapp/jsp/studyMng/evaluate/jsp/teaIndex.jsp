...
<script type="text/javascript" src="${webPath}jsp/studyMng/evaluate/js/teaIndex.js?v=2017030902"></script>
...
<!-- 					<a role="button" class="btn btn-success btn-primary">查询</a> -->
			    ...
			    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="mytable caozuo  mb20 table">
					<tr>
							...
							<th class="text-left" width="20%">评教活动</th>
							<th  class="text-left" width="20%">学年学期</th>
							<th  class="text-left" width="18%">评价学生</th>
							<th  class="text-left" width="18%">被评价教师</th>
							<th  class="text-left" width="15%">总分</th>
 						...
 						{{title}}
					      ...
					      {{totalScore}}
					       ...
					       <td><p class="clearfix text-right  pr8">
					   		       <a class="ico-edit icon-caozuo f0 fr mr10" href="javascript:void(0);"onclick="getById('{{evaluateKey}}','{{teacherKey}}','{{studentKey}}');" title="编辑" >编辑</a>
				   		    </p>
				   		   </td>
					  </tr>
				   {{/obj}}
...
<!-- 选择判断是否的选择面板 -->
 ...
 <script type="text/javascript">
		...
		//获取修改面板		
		function getById (evaluateKey,teacherKey,studentKey){
			var url="${webPath}studyMng/evaluate/toTeacherEval.do?evaluateKey="+evaluateKey+"&teacherKey="+teacherKey+"&studentKey="+studentKey;
			location = url;
		}
 </script>