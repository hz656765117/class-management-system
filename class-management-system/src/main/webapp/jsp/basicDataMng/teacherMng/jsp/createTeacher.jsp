      		...
      		<div class="m0a" style="margin-top:42px;width:480px">
		        <div class="f14 lh30  hei01  mt20 clearfix">
		         ...
		         <div class="f14 lh30  hei01  mt20 clearfix">
		          ...
		          <input type="radio" value="2" name="sex" <c:if test="${teacher.sex=='2'}">checked="checked"</c:if>>女
		        </div>
		        <div class="f14 lh30  hei01  mt20 clearfix">
		          <label class="f14 fl hei01 w80 fl lh30 text-right">教师职称：</label>
		          <input id="idcardNumber" type="text" value="${teacher.idcardNumber}" placeholder="请输入教师职称" class="lh28 h28 w322 pl10 bd-hui02 fl ml10">
		        </div>
