...
<script type="text/javascript" src="${webPath}jsp/appraisal/js/student.prize.js?v=2017030902"></script>
<style>
	.view-box{
		z-index:10005;
	}
	  ...
	  <div class="landtitle">
	    ...
	    <div class="mb10 mt10 searchVo">
				<form class=" form-inline form-inline-sm">
					<a role="button" class="btn btn-primary mr8" href="${webPath}prize/toPrizeApply.do"  >新建</a>
 ...
 var setting1 = {
	...
	var setting2 = {
	  ...
	  function checkedNodes(treeId, parentNode, childNodes){
		...
		function getById (id){
			var url="${webPath}prize/toUpdatePrizeApply.do?id="+id;
			location = url;
		}
